...
var catalog = map[string]map[string]string{
	"en": {
		...
		"public.add.job_done":          "All done! Videos imported:",
		"public.add.job_error":         "That import hit a snag:",
	...
	"ru": {
		...
		"admin.dashboard.total_views":      "Всего просмотров",
		...
		"public.add.job_done":          "Готово! Импортировано видео:",
		"public.add.job_error":         "Импорт споткнулся:",
